    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span> Quản lý Doanh thu</h4>
...
<%--              <button type="submit" style="width:80px;margin-top:10px;margin-left: 70px" class="btn btn-primary" class="btn btn-primary">In Excel</button>--%>
